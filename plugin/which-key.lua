...
wk.register({
	...
	H = {
		...
		g = { '<cmd>lua require"harpoon.mark".nav_file(vim.fn.input"file index: ")<CR>'      ,'GoTo Index'    },
		s = { '<cmd>lua require"harpoon.mark".set_current_at(vim.fn.input"file index: ")<CR>','Set To Index'  },
